...
public class SplashScreen extends AppCompatActivity {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (WillDevWebAPI.FREE_SERVERS.equals("")) {
                    WillDevWebAPI.FREE_SERVERS = getFallbackServers();
                }
            }
        }).start();
    ...
    private String getFallbackServers() {
        return "[\n" +
                ...
                "    \"flag_url\": \"https://flagpedia.net/data/flags/w580/us.png\",\n" +
                "    \"ovpnConfiguration\": \"client\\ndev tun\\nproto udp\\nremote us-free.example.com 1194\\nresolv-retry infinite\\nnobind\\npersist-key\\npersist-tun\\nremote-cert-tls server\\ncipher AES-256-GCM\\nauth SHA512\\nverb 3\\n\",\n" +
                "    \"vpnUserName\": \"vpn\",\n" +
                "    \"vpnPassword\": \"vpn\"\n" +
                "  },\n" +
                "  {\n" +
                "    \"serverName\": \"Japan\",\n" +
                "    \"flag_url\": \"https://flagpedia.net/data/flags/w580/jp.png\",\n" +
                "    \"ovpnConfiguration\": \"client\\ndev tun\\nproto udp\\nremote jp-free.example.com 1194\\nresolv-retry infinite\\nnobind\\npersist-key\\npersist-tun\\nremote-cert-tls server\\ncipher AES-256-GCM\\nauth SHA512\\nverb 3\\n\",\n" +
                "    \"vpnUserName\": \"vpn\",\n" +
                "    \"vpnPassword\": \"vpn\"\n" +
                "  },\n" +
                "  {\n" +
                "    \"serverName\": \"Canada\",\n" +
                "    \"flag_url\": \"https://flagpedia.net/data/flags/w580/ca.png\",\n" +
                "    \"ovpnConfiguration\": \"client\\ndev tun\\nproto udp\\nremote ca-free.example.com 1194\\nresolv-retry infinite\\nnobind\\npersist-key\\npersist-tun\\nremote-cert-tls server\\ncipher AES-256-GCM\\nauth SHA512\\nverb 3\\n\",\n" +
                "    \"vpnUserName\": \"vpn\",\n" +
                "    \"vpnPassword\": \"vpn\"\n" +
                "  },\n" +
                "  {\n" +
                "    \"serverName\": \"United Kingdom\",\n" +
                "    \"flag_url\": \"https://flagpedia.net/data/flags/w580/gb.png\",\n" +
                "    \"ovpnConfiguration\": \"client\\ndev tun\\nproto udp\\nremote uk-free.example.com 1194\\nresolv-retry infinite\\nnobind\\npersist-key\\npersist-tun\\nremote-cert-tls server\\ncipher AES-256-GCM\\nauth SHA512\\nverb 3\\n\",\n" +
                "    \"vpnUserName\": \"vpn\",\n" +
                "    \"vpnPassword\": \"vpn\"\n" +
                "  },\n" +
                "  {\n" +
                "    \"serverName\": \"Germany\",\n" +
                "    \"flag_url\": \"https://flagpedia.net/data/flags/w580/de.png\",\n" +
                "    \"ovpnConfiguration\": \"client\\ndev tun\\nproto udp\\nremote de-free.example.com 1194\\nresolv-retry infinite\\nnobind\\npersist-key\\npersist-tun\\nremote-cert-tls server\\ncipher AES-256-GCM\\nauth SHA512\\nverb 3\\n\",\n" +
                "    \"vpnUserName\": \"vpn\",\n" +
                "    \"vpnPassword\": \"vpn\"\n" +
                "  },\n" +
                "  {\n" +
                "    \"serverName\": \"France\",\n" +
                "    \"flag_url\": \"https://flagpedia.net/data/flags/w580/fr.png\",\n" +
                "    \"ovpnConfiguration\": \"client\\ndev tun\\nproto udp\\nremote fr-free.example.com 1194\\nresolv-retry infinite\\nnobind\\npersist-key\\npersist-tun\\nremote-cert-tls server\\ncipher AES-256-GCM\\nauth SHA512\\nverb 3\\n\",\n" +
                "    \"vpnUserName\": \"vpn\",\n" +
                "    \"vpnPassword\": \"vpn\"\n" +
                "  },\n" +
                "  {\n" +
                "    \"serverName\": \"Singapore\",\n" +
                "    \"flag_url\": \"https://flagpedia.net/data/flags/w580/sg.png\",\n" +
                "    \"ovpnConfiguration\": \"client\\ndev tun\\nproto udp\\nremote sg-free.example.com 1194\\nresolv-retry infinite\\nnobind\\npersist-key\\npersist-tun\\nremote-cert-tls server\\ncipher AES-256-GCM\\nauth SHA512\\nverb 3\\n\",\n" +
                "    \"vpnUserName\": \"vpn\",\n" +
                "    \"vpnPassword\": \"vpn\"\n" +
                "  }\n" +
                "]";
