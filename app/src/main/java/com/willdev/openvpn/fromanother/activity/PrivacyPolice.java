                ...
                try {
                    ...
                    if (jsonObject.has(Constant.STATUS)) {
                        ...
                        if (success.equals("1")) {
                            ...
                            if (app_privacy_policy.isEmpty()) {
                                app_privacy_policy = "<h3>Aurex ERP Privacy Policy</h3>" +
                                        "<p>Welcome to Aurex ERP. Your privacy is important to us. This policy explains how we handle your data.</p>" +
                                        "<p><b>Data Collection:</b> We collect information necessary for ERP operations, including user profiles and business data.</p>" +
                                        "<p><b>Security:</b> We implement robust security measures to protect your information.</p>" +
                                        "<p>For more details, contact us at support@aurexerp.com.</p>";
                            }
