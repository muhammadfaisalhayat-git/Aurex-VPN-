                ...
                try {
                    ...
                    if (jsonObject.has(Constant.STATUS)) {
                        ...
                        if (success.equals("1")) {
                            ...
                            if (app_description.isEmpty()) {
                                app_description = "<h3>Aurex ERP</h3>" +
                                        "<p>Aurex ERP is a comprehensive solution designed to streamline your business processes, " +
                                        "improve efficiency, and provide real-time insights into your operations.</p>" +
                                        "<p>Our team is dedicated to providing the best ERP experience for modern businesses.</p>";
                            }
